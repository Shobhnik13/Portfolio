...
const HireMe = () => {
  return (
    <div className=" flex flex-col justify-center gap-y-3 mt-4 bg-purple-100 shadow-md rounded-lg p-4">
        <p className="text-sm 2xl:text-base">I am currently open for <span className="font-bold">software engineering roles</span> , which involves building and maintaining scalable softwares.</p>
